...
How would you implement the `promise.catch` functionality using the `fcb` function in this alternative approach?
...
```
 ...
 What do you think will be the output of the above code? 
